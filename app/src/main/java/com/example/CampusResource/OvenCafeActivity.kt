...
import com.example.CampusResource.databinding.ActivityOvenBinding
import com.example.CampusResource.ui.MenuRenderer
import com.google.android.material.datepicker.MaterialDatePicker
import java.text.SimpleDateFormat
import java.util.*

class OvenCafeActivity : AppCompatActivity() {

    private lateinit var binding: ActivityOvenBinding
    ...
    private fun lunchByDay(day: Int): List<String> =
        when (day) {
            Calendar.MONDAY -> listOf(
                "Buffalo Fried Chicken Pizza",
                "Cheese Pizza",
                "Pepperoni Pizza"
            )
            Calendar.TUESDAY -> listOf(
                "Three Calzone Cheese",
                "Cheese Pizza",
                "Pepperoni Pizza"
            )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityOvenBinding.inflate(layoutInflater)
